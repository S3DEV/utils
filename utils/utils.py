...
21.12.17    J. Berendt      4.4.0       **FUNCTIONAL CHANGES**
                                        Added the ping() function - which currently only supports
                                        Windows.
                                        Added the _get_os() function for central OS identification
                                        for use by local functions.
                                        **FORMATTING CHANGES**
                                        Moved global imports into the method/function which uses
                                        them.
